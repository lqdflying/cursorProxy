...
OAI_RESP_HALO_KEY provider: openaicompat source: ... key: halo_...
OAI_RESP_HALO_SESSION provider: openaicompat source: ... hash: ...
OAI_RESP_HALO_TOOL_OUTPUT_STATELESS provider: openaicompat inputItems: <n> toolOutputs: <n>
OAI_GET_MCP_TOOLS_ARGS_SANITIZED provider: openaicompat name: GetMcpTools ...
OAI_CALL_MCP_TOOL_SCHEMA_FIXED provider: openaicompat count: <n> # halo only
