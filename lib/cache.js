...
// `keyPrefix` is parameterizable: defaults to `"asst:"` for the Claude thinking
// cache; `openaicompatConversationHash` passes `"conv:"` to sit in the
// reasoning-bridge prefix namespace while keeping a canonicalized payload.
