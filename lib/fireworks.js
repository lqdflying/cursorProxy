...
// Official Fireworks GLM 5.2 model identifier. Scoped narrowly to the documented
// ID only; do not speculate on future versions or custom-account contracts
// without verifying them.
const FIREWORKS_GLM_52_ID = "accounts/fireworks/models/glm-5p2";

export function isFireworksGlm52Model(upstreamModelName) {
  if (typeof upstreamModelName !== "string") return false;
  return upstreamModelName.toLowerCase() === FIREWORKS_GLM_52_ID;
}
