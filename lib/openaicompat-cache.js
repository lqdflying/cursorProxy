...
const OPENAICOMPAT_CACHE_HIT_MODES = new Set(["default", "sub2api", "halo", "passion8"]);
const OPENAICOMPAT_HALO_COMPATIBLE_CACHE_HIT_MODES = new Set(["halo", "passion8"]);
...
export function isOpenAICompatHaloCompatibleCacheMode() {
  return OPENAICOMPAT_HALO_COMPATIBLE_CACHE_HIT_MODES.has(openAICompatCacheHitMode());
}
